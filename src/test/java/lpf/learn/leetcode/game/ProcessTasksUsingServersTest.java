...
public class ProcessTasksUsingServersTest {
    @Test
    public void test1(){
        ProcessTasksUsingServers test = new ProcessTasksUsingServers();
        Assert.assertArrayEquals(new int[]{2,2,0,2,1,2}, test.assignTasks(new int[]{3,3,2}, new int[]{1,2,3,2,1,2}));
    }

    @Test
    public void test2(){
        ProcessTasksUsingServers test = new ProcessTasksUsingServers();
        Assert.assertArrayEquals(new int[]{1,4,1,4,1,3,2}, test.assignTasks(new int[]{5,1,4,3,2}, new int[]{2,1,2,4,5,2,1}));
    }

    @Test
    public void test3(){
        ProcessTasksUsingServers test = new ProcessTasksUsingServers();
        Assert.assertArrayEquals(new int[]{8,0,3,9,5,1,10,6,4,2,7,9,0}, test.assignTasks(new int[]{10,63,95,16,85,57,83,95,6,29,71}, new int[]{70,31,83,15,32,67,98,65,56,48,38,90,5}));
    }

    @Test
    public void test4(){
        ProcessTasksUsingServers test = new ProcessTasksUsingServers();
        Assert.assertArrayEquals(new int[]{12,7,10,14,11,15,1,2,8,17,4}, test.assignTasks(new int[]{74,57,61,82,67,97,67,21,61,79,21,50,14,88,48,52,76,64}, new int[]{21,100,48,64,20,8,28,10,3,63,7}));
    }

    @Test
    public void test5(){
        ProcessTasksUsingServers test = new ProcessTasksUsingServers();
        Assert.assertArrayEquals(new int[]{26,50,47,11,56,31,18,55,32,9,4,2,23,53,43,0,44,30,6,51,29,51,15,17,22,34,38,33,42,3,25,10,49,51,7,58,16,21,19,31,19,12,41,35,45,52,13,59,47,36,1,28,48,39,24,8,46,20,5,54,27,37,14,57,40,59,8,45,4,51,47,7,58,4,31,23,54,7,9,56,2,46,56,1,17,42,11,30,12,44,14,32,7,10,23,1,29,27,6,10,33,24,19,10,35,30,35,10,17,49,50,36,29,1,48,44,7,11,24,57,42,30,10,55,3,20,38,15,7,46,32,21,40,16,59,30,53,17,18,22,51,11,53,36,57,26,5,36,56,55,31,34,57,7,52,37,31,10,0,51,41,2,32,25,0,7,49,47,13,14,24,57,28,4,45,43,39,38,8,2,44,45,29,25,25,12,54,5,44,30,27,23,26,7,33,58,41,25,52,40,58,9,52,40},
                test.assignTasks(new int[]{338,890,301,532,284,930,426,616,919,267,571,140,716,859,980,469,628,490,195,664,925,652,503,301,917,563,82,947,910,451,366,190,253,516,503,721,889,964,506,914,986,718,520,328,341,765,922,139,911,578,86,435,824,321,942,215,147,985,619,865},
