...
public class FloodFill {
    public int[][] floodFill(int[][] image, int sr, int sc, int newColor) {
        ...
        while (!queue.isEmpty()) {
            ...
            addQueue(image, queue, visited, point[0] + 1, point[1], oldColor);
            addQueue(image, queue, visited, point[0], point[1] + 1, oldColor);
            addQueue(image, queue, visited, point[0] - 1, point[1], oldColor);
            addQueue(image, queue, visited, point[0], point[1] - 1, oldColor);
        }
        return image;
    ...
    private void addQueue(int[][] image, Queue<int[]> queue, boolean[][] visited, int x, int y, int oldColor) {
