...
public class CheckIfThereIsAValidPathInAGrid {
    ...
    private final boolean[][] check = new boolean[][]{{},
            {false, false, true, true, true, false, false}, // 2,3,4
            {false, true, false, true, false, true, false}, // 1,3,5
            {false, false, true, false, false, true, true}, // 2,5,6
            {false, true, false, false, true, false, true}  // 1,4,6
    };
