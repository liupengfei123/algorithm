...
public class CountVowelStringsInRanges {
    ...
    private static final boolean[] vowelFlags = new boolean[26];

    static {
        int[] temp = new int[]{'a', 'e', 'i', 'o', 'u'};
        for (int i : temp) vowelFlags[i - 'a'] = true;
    }
    ...
    private boolean isVowelString(String str) {
        return vowelFlags[str.charAt(0) - 'a'] && vowelFlags[str.charAt(str.length() - 1) - 'a'];
