...
public class BookingConcertTicketsInGroups {
    ...
    public int[] gather(int k, int maxRow) {
        ...
        for (int i = minRow; i <= maxRow; i++) {
            int canUse = m - rowUsedCount[i];
            if (canUse >= k) {
                int[] result = {i, rowUsedCount[i]};
                rowUsedCount[i] += k;
